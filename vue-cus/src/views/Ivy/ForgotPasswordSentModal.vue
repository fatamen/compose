        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-4">
                ...
                <div class="modal-body d-flex flex-column align-items-center pt-0">
                    ...
                    <div class="fw-bold title mb-1" style="font-size:2rem;">查看email</div>
                    <div class="desc mb-4" style="color:#555;font-size:1.08rem;">
                        我們已將重設密碼步驟的email發送給你。別忘了查看你的垃圾郵件信箱喔。
                    </div>
                    <button class="btn btn-main w-100 mt-2" @click="emit('backToLogin')">Back to login</button>
                </div>
            </div>
        </div>
    </div>
